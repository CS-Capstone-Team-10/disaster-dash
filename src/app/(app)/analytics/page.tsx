        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-muted border border-border rounded-lg text-sm text-foreground focus:border-blue-500 focus:outline-none"
            >
          ...
          {/* Disaster Type */}
          <div>
            <label className="block text-sm text-muted-foreground mb-2">Disaster Type</label>
            <select
              value={disasterType}
